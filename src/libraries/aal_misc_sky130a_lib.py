...
def generate_local_traces_for_aal_misc_sky130a_lib_pnp_bipolars(self):
...
def generate_local_traces_for_aal_misc_sky130a_lib_mim_capacitors(self):
    ...
    for structural_component in self.structural_components:
        if re.search(rf"\b{rail}\b", structural_component.name, re.IGNORECASE):
            ...
            for comp in group_components:
                ...
                trace.vias.append(RectAreaLayer(layer='locali-m3', area=via_connect))
